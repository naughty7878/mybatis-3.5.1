...
public class XMLMapperBuilder extends BaseBuilder {
  ...
  public void parse() {
    ...
    // 解析还未完成的 ResultMap 结果Map
    parsePendingResultMaps();
    // 解析还未完成的 CacheRef  缓存引用
  ...
  private void configurationElement(XNode context) {
    try {
      ...
      // 解析缓存引用  <cache-ref> 节点
      // <cache-ref namespace="com.test.pojo.DeptMapper"></cache-ref>
      ...
      // 解析 select | insert |update |delete节点
  ...
  private void buildStatementFromContext(List<XNode> list, String requiredDatabaseId) {
    // 循环 select|delte|insert|update节点
