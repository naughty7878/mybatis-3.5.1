...
public class ParameterHandlerPlugin implements Interceptor {
	...
	public Object intercept(Invocation invocation) throws Throwable {
		...
		System.out.println("ParameterHandlerPlugin...intercept:\n\t\t" + invocation.getMethod());
	...
	public Object plugin(Object target) {
		...
		if(target instanceof ParameterHandler) {
			...
			System.out.println("ParameterHandler...plugin:\n\t\tmybatis将要包装的对象" + target);
			// 返回为当前target创建的动态代理
	...
	public void setProperties(Properties properties) {
		// TODO Auto-generated method stub
		System.out.println("ParameterHandlerPlugin插件配置的信息：" + properties);
	}
